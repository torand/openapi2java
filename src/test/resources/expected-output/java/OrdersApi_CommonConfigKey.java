...
import static io.github.torand.openapi2java.test.OrdersApi_CommonConfigKey.ROOT_PATH;
...
@RegisterRestClient(configKey = "commonconfigkey-api")
...
@Path(ROOT_PATH)
public interface OrdersApi_CommonConfigKey {
