...
import static io.github.torand.openapi2java.test.ProductsApi_CommonHeadersFactory.ROOT_PATH;
...
public interface ProductsApi_CommonHeadersFactory {
    ...
    Response uploadProductDatasheet(
        ...
        @HeaderParam(ACCEPT_LANGUAGE) String acceptLanguage,
        @HeaderParam("X-User-ID") @NotBlank String xUserID,
        @RestForm("filename") @PartType(TEXT_PLAIN) @NotBlank @Pattern(regexp = "^[a-zA-Z0-9]{1,100}\\.[a-zA-Z0-9]{1,3}?$") String filename,
